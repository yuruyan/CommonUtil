...
public static class DataSet {
    ...
    public static readonly IReadOnlyList<ToolMenuItem> ToolMenuItems = new List<ToolMenuItem>() {
        ...
        new("顺序文本生成", $"{Global.ImageSource}order.png", typeof(OrdinalTextGeneratorView)),
        new("文件内容搜索", $"{Global.ImageSource}FileSearch.png", typeof(KeywordFinderView)),
        new("文本工具", $"{Global.ImageSource}TextTool.png", typeof(TextToolView)),
        new("二维码工具", $"{Global.ImageSource}qrcode.png", typeof(QRCodeToolView)),
        new("颜色转换", $"{Global.ImageSource}ColorPicker.png", typeof(ColorTransformView)),
        //new("代码格式化", $"{Global.ImagePath}format.png", typeof(CodeFormatingView)),
        new("成语接龙", $"{Global.ImageSource}IdiomMatching.png", typeof(IdiomMatchingView)),
        new("正则匹配提取", $"{Global.ImageSource}regex.png", typeof(RegexExtractionView)),
        //new("FTP 服务器", $"{Global.ImagePath}ftp.png", typeof(FtpServerView)),
        new("浏览器书签导出", $"{Global.ImageSource}MicrosoftEdge.png", typeof(BrowserBookmarkView)),
        new("代码生成器", $"{Global.ImageSource}CodeGenerator.png", typeof(CodeGeneratorView)),
        new("临时文件版本控制", $"{Global.ImageSource}FileVersion.png", typeof(TempFileVersionControlView)),
        new("简单文件服务器", $"{Global.ImageSource}file-server.png", typeof(SimpleFileSystemServerView)),
        new("代码着色", $"{Global.ImageSource}paint.png", typeof(CodeColorizationView)),
        new("文件下载器", $"{Global.ImageSource}download.png", typeof(DownloaderView)),
        new("集合工具", $"{Global.ImageSource}Intersection.png", typeof(CollectionToolView)),
        new("JSON 数据提取", $"{Global.ImageSource}json.png", typeof(JsonExtractorView)),
        new("桌面自动化", $"{Global.ImageSource}Automation.png", typeof(DesktopAutomationView)),
    };
