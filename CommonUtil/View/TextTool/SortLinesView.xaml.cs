...
public partial class SortLinesView : Page {
    ...
    public static readonly DependencyProperty IsExpandedProperty = DependencyProperty.Register("IsExpanded", typeof(bool), typeof(SortLinesView), new PropertyMetadata(true));
